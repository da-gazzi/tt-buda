...
$(PYBUDA_CSRC_LIB): $(PYBUDA_CSRC_OBJS) $(PYBUDA_CSRC_GRAPH_LIB) $(PYBUDA_CSRC_AUTOGRAD) $(PYBUDA_CSRC_PATTERN_MATCHER_LIB) $(PYBUDA_CSRC_BALANCER_LIB) $(PYBUDA_CSRC_PLACER_LIB) $(PYBUDA_CSRC_SCHEDULER_LIB) $(PYBUDA_CSRC_REPORTIFY) $(PYBUDA_CSRC_BACKENDAPI_LIB) $(PYBUDA_CSRC_SHARED_UTILS_LIB) $(PYBUDA_CSRC_TILE_MAPS_LIB) $(PYBUDA_CSRC_PERF_MODEL_LIB) $(PYBUDA_THIRD_PARTY_DEPS) $(PYBUDA_THIRD_PARTY_DEPS) $(PYBUDA_CSRC_TT_TORCH_DEVICE_LIB)
	@mkdir -p $(LIBDIR)
